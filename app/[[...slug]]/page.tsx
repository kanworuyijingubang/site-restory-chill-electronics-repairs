...
export default async function Page({ params }: { params: Promise<{ slug?: string[] }> }) {
  ...
  const graph: Record<string, unknown>[] = [
    { "@type": "WebPage", "@id": absoluteUrl(page.path), url: absoluteUrl(page.path), name: page.title, description: page.description, dateModified: "2026-08-24", isPartOf: { "@id": `${SITE_URL}/#website` } },
